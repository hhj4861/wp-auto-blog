...
FAQ = [
    ("Q1. 탈모 영양제는 얼마나 먹어야 효과가 보이나요?",
     "모발은 성장기·퇴행기·휴지기 주기를 거치기 때문에 최소 <strong style=\"color:#6ee7b7\">3~6개월</strong>은 꾸준히 먹어야 변화를 판단할 수 있어요. 2~3주 만에 효과가 없다고 중단하지 마세요."),
    ("Q2. 영양제·앰플·스케일러를 꼭 다 써야 하나요?",
     "세 가지는 각각 몸속(원료)·두피(도포)·모공(청결)이라는 <strong style=\"color:#60a5fa\">다른 지점</strong>을 건드립니다. 하나만 해도 되지만, 병행하면 서로의 효과를 받쳐줍니다. 부담되면 영양제 → 앰플 → 스케일러 순으로 하나씩 추가해보세요."),
    ("Q3. 두피 스케일러는 매일 써도 되나요?",
     "아니요. 매일 하면 두피가 오히려 예민해질 수 있어 <strong style=\"color:#6ee7b7\">주 1~2회</strong>가 적당합니다. 손톱이 아니라 지문면으로 문질러 두피 상처를 피하세요."),
    ("Q4. 이렇게 관리하면 탈모가 멈추나요?",
     "영양제·앰플·스케일러는 건강기능식품·화장품이지 <strong style=\"color:#60a5fa\">의약품이 아닙니다.</strong> 예방·관리·두피 환경 개선을 돕는 것이며, 단기간에 넓게 빠지거나 원형으로 빠진다면 피부과 진료가 먼저입니다."),
]
SOURCES = [
    "(식품의약품안전처) 건강기능식품 기능성 원료(비오틴 등) 정보",
    "(질병관리청 국가건강정보포털) 탈모의 원인과 관리",
    "(대한피부과학회) 탈모 일반 정보",
]
