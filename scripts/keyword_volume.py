...
# 검색모듈(keyword-intel) opportunity 상위 후보들 = 시드
SEEDS = [
    "각질 필링", "알부틴 크림", "저속노화 영양제", "티트리 스팟", "츄어블 칼슘",
    "데오드란트", "액상 프로폴리스", "이눌린", "락토페린", "다이어트 도시락",
    "모공 토너", "시트룰린", "두피 스케일러", "바쿠치올 세럼", "부모님 영양제 선물",
]
POSTED = {"각질필링", "알부틴크림", "바쿠치올세럼", "두피스케일러"}
